...
exports.ExperienceLetter = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const ExperienceLetterSchema = new mongoose_1.default.Schema({
    regNo: {
        type: String,
        required: true,
        trim: true,
...
exports.ExperienceLetter = mongoose_1.default.model("ExperienceLetter", ExperienceLetterSchema);
